...
namespace BaseLibS.Mol{
	public static class ChemElements{
		...
		private static ChemElement[] InitElements(){
			ChemElement[] e = {
				new ChemElement(1, "H", "Hydrogen", new[]{1.0078250321, 2.014101778}, new[]{99.9885, 0.0115}, 1.00794,
					ChemElementType.Nonmetal, new[]{1}, "1333-74-0", false, 200),
				...
				new ChemElement(1, "T", "Tritium", new[]{1.0078250321, 2.014101778, 3.0160492777},
					new[]{0.0, 0.0, 100.0}, 3.0160492777, ChemElementType.Nonmetal, new[]{1}, "10028-17-8", true),
				new ChemElement(2, "He", "Helium", new[]{3.0160293191, 4.00260325415}, new[]{0.000134, 99.999866},
					4.002602, ChemElementType.NobleGas, new[]{0}),
				new ChemElement(3, "Li", "Lithium", new[]{6.0151223, 7.0160040}, new[]{7.59, 92.41}, 6.941,
					ChemElementType.AlkaliMetal, new[]{1}),
				new ChemElement(5, "B", "Boron", new[]{10.0129370, 11.0093055}, new[]{19.9, 80.1}, 10.811,
					ChemElementType.Semimetal, new[]{-3, 3}),
				new ChemElement(4, "Be", "Beryllium", new[]{9.0121822}, new[]{100.0}, 9.0121822,
					ChemElementType.AlkalineEarth, new[]{2}),
				new ChemElement(6, "C", "Carbon", new[]{12.0, 13.0033548378}, new[]{98.93, 1.07}, 12.0107,
					ChemElementType.Nonmetal, new[]{4, 2}, "7440-44-0", false, 200),
				...
				new ChemElement(7, "N", "Nitrogen", new[]{14.0030740052, 15.0001088984}, new[]{99.632, 0.368}, 14.0067,
					ChemElementType.Nonmetal, new[]{-3, -2, -1, +2, +3, +4, +5}, "", false, 100),
				new ChemElement(7, "Nx", "Nitrogen", new[]{14.0030740052, 15.0001088984}, new[]{0.0, 100.0},
					15.0001088984, ChemElementType.Nonmetal, new[]{-3, -2, -1, +2, +3, +4, +5}, "", true),
				new ChemElement(8, "O", "Oxygen", new[]{15.9949146221, 16.9991315, 17.9991604},
				...
				new ChemElement(8, "Oy", "Oxygen", new[]{15.9949146221, 16.9991315}, new[]{0.0, 100.0}, 16.9991315,
					ChemElementType.Nonmetal, new[]{-2}, "", true),
				new ChemElement(9, "F", "Fluorine", new[]{18.99840320}, new[]{100.0}, 18.9984032,
					ChemElementType.Halogen, new[]{-1}),
				new ChemElement(10, "Ne", "Neon", new[]{19.9924401754, 20.99384668, 21.991385114},
					new[]{90.48, 0.27, 9.25}, 20.1797, ChemElementType.NobleGas, new[]{0}),
				new ChemElement(11, "Na", "Sodium", new[]{22.98976967}, new[]{100.0}, 22.989770,
					ChemElementType.AlkaliMetal, new[]{1}),
				new ChemElement(12, "Mg", "Magnesium", new[]{23.985041700, 24.98583692, 25.982592929},
					new[]{78.99, 10.00, 11.01}, 24.3050, ChemElementType.AlkalineEarth, new[]{2}),
				new ChemElement(13, "Al", "Aluminum", new[]{26.98153863}, new[]{100.0}, 26.98153863,
					ChemElementType.BasicMetal, new[]{3}),
				new ChemElement(15, "P", "Phosphorus", new[]{30.97376151}, new[]{100.0}, 30.973761,
				...
				new ChemElement(16, "Sy", "Sulfur", new[]{31.97207069, 32.9714585}, new[]{0.0, 100.0}, 32.9714585,
					ChemElementType.Nonmetal, new[]{-2, 2, 4, 6}, "", true),
				new ChemElement(14, "Si", "Silicon", new[]{27.9769265325, 28.976494700, 29.97377017},
				...
				new ChemElement(18, "Ar", "Argon", new[]{35.967545106, 37.9627324, 39.9623831225},
					new[]{0.3365, 0.0632, 99.6003}, 39.948, ChemElementType.NobleGas, new[]{0}),
				new ChemElement(19, "K", "Potassium", new[]{38.9637069, 39.96399867, 40.96182597},
					new[]{93.2581, 0.0117, 6.7302}, 39.0983, ChemElementType.AlkaliMetal, new[]{1}),
				new ChemElement(19, "Kx", "Potassium", new[]{38.9637069, 39.96399867, 40.96182597},
					new[]{0.0, 0.0, 100.0}, 40.96182597, ChemElementType.AlkaliMetal, new[]{1}, "", true),
				new ChemElement(21, "Sc", "Scandium", new[]{44.9559119}, new[]{100.0}, 44.9559119,
				...
				new ChemElement(25, "Mn", "Manganese", new[]{54.9380451}, new[]{100.0}, 54.938045,
				...
				new ChemElement(28, "Ni", "Nickel", new[]{57.9353479, 59.9307906, 60.9310604, 61.9283488, 63.9279696},
					...
					new[]{2}),
				new ChemElement(27, "Co", "Cobalt", new[]{58.9331950}, new[]{100.0}, 58.933195,
				...
				new ChemElement(31, "Ga", "Gallium", new[]{68.9255736, 70.9247013}, new[]{60.108, 39.892}, 69.723,
					ChemElementType.BasicMetal, new[]{3}),
				new ChemElement(32, "Ge", "Germanium",
				...
				new ChemElement(33, "As", "Arsenic", new[]{74.9215964}, new[]{100.0}, 74.92160,
					ChemElementType.Semimetal, new[]{-3, 3, 5}),
				new ChemElement(34, "Se", "Selenium",
				...
				new ChemElement(39, "Y", "Yttrium", new[]{88.9058483}, new[]{100.0}, 88.9058483,
					ChemElementType.TransitionMetal, new[]{3}),
				new ChemElement(40, "Zr", "Zirconium",
				...
				new ChemElement(41, "Nb", "Niobium", new[]{92.9063781}, new[]{100.0}, 92.90638,
					ChemElementType.TransitionMetal, new[]{3, 5}, "7440-03-1"),
				new ChemElement(45, "Rh", "Rhodium", new[]{102.905504}, new[]{100.0}, 102.905504,
				...
				new ChemElement(42, "Mo", "Molybdenum",
					...
					new[]{3, 6}, "7439-98-7"),
				new ChemElement(43, "Tc", "Technetium", new[]{98.9062547}, new[]{100.0}, 98.9062547,
				...
				new ChemElement(44, "Ru", "Ruthenium",
					...
					new[]{3, 4, 8}, "7440-18-8"),
				new ChemElement(46, "Pd", "Palladium",
				...
				new ChemElement(56, "Ba", "Barium",
					...
					new[]{2}),
				new ChemElement(55, "Cs", "Cesium", new[]{132.905451933}, new[]{100.0}, 132.905451933,
					ChemElementType.AlkaliMetal, new[]{1}),
				new ChemElement(59, "Pr", "Praseodymium", new[]{140.9076528}, new[]{100.0}, 140.90765,
				...
				new ChemElement(60, "Nd", "Neodymium",
					...
					"7440-00-8"),
				new ChemElement(61, "Pm", "Promethium", new[]{144.912749}, new[]{100.0}, 144.912749,
				...
				new ChemElement(65, "Tb", "Terbium", new[]{158.9253468}, new[]{100.0}, 158.92535,
				...
				new ChemElement(66, "Dy", "Dysprosium",
					...
					new[]{3}),
				new ChemElement(67, "Ho", "Holmium", new[]{164.9303221}, new[]{100.0}, 164.93032,
					ChemElementType.Lanthanide, new[]{3}),
				...
				new ChemElement(69, "Tm", "Thulium", new[]{168.9342133}, new[]{100.0}, 168.93421,
					ChemElementType.Lanthanide, new[]{3}),
				...
				new ChemElement(78, "Pt", "Platinum",
					...
					new[]{2, 4, 6}),
				new ChemElement(79, "Au", "Gold", new[]{196.966552}, new[]{100.0}, 196.96655,
				...
				new ChemElement(83, "Bi", "Bismuth", new[]{208.9803987}, new[]{100.0}, 208.98040,
					ChemElementType.BasicMetal, new[]{3}),
				new ChemElement(84, "Po", "Polonium", new[]{208.9824304}, new[]{100.0}, 208.9824304,
					ChemElementType.Semimetal, new[]{2, 4}),
				new ChemElement(85, "At", "Astatine", new[]{209.987148}, new[]{100.0}, 209.987148,
					ChemElementType.Halogen),
				new ChemElement(86, "Rn", "Radon", new[]{222.0175777}, new[]{100.0}, 222.0175777,
					ChemElementType.NobleGas, new[]{0}),
				new ChemElement(87, "Fr", "Francium", new[]{223.0197359}, new[]{100.0}, 223.0197359,
					ChemElementType.AlkaliMetal),
				new ChemElement(88, "Ra", "Radium", new[]{226.0254098}, new[]{100.0}, 226.0254098,
					ChemElementType.AlkalineEarth, new[]{0}),
				new ChemElement(89, "Ac", "Actinium", new[]{227.0277521}, new[]{100.0}, 227.0277521,
					ChemElementType.Actinide, new[]{3}),
				new ChemElement(90, "Th", "Thorium", new[]{232.0380553}, new[]{100.0}, 232.0380553,
					ChemElementType.Actinide, new[]{4}),
				new ChemElement(91, "Pa", "Protactinium", new[]{231.0358840}, new[]{100.0}, 231.0358840,
					ChemElementType.Actinide, new[]{5}),
				new ChemElement(92, "U", "Uranium", new[]{234.0409521, 235.0439299, 238.0507882},
					new[]{0.0054, 0.7204, 99.2742}, 238.02891, ChemElementType.Actinide, new[]{3, 4, 6}),
				new ChemElement(93, "Np", "Neptunium", new[]{237.0481734}, new[]{100.0}, 237.0481734,
					ChemElementType.Actinide),
				new ChemElement(94, "Pu", "Plutonium", new[]{244.064204}, new[]{100.0}, 244.064204,
					ChemElementType.Actinide),
				new ChemElement(95, "Am", "Americium", new[]{243.0613811}, new[]{100.0}, 243.0613811,
					ChemElementType.Actinide),
				new ChemElement(96, "Cm", "Curium", new[]{247.070354}, new[]{100.0}, 247.070354,
					ChemElementType.Actinide),
				new ChemElement(97, "Bk", "Berkelium", new[]{247.070307}, new[]{100.0}, 247.070307,
					ChemElementType.Actinide),
				new ChemElement(98, "Cf", "Californium", new[]{251.079587}, new[]{100.0}, 251.079587,
					ChemElementType.Actinide),
				new ChemElement(99, "Es", "Einsteinium", new[]{252.082980}, new[]{100.0}, 252.082980,
					ChemElementType.Actinide),
				new ChemElement(100, "Fm", "Fermium", new[]{257.095105}, new[]{100.0}, 257.095105,
					ChemElementType.Actinide),
				new ChemElement(101, "Md", "Mendelevium", new[]{258.098431}, new[]{100.0}, 258.098431,
					ChemElementType.Actinide),
				new ChemElement(102, "No", "Nobelium", new[]{259.10103}, new[]{100.0}, 259.10103,
					ChemElementType.Actinide),
				new ChemElement(103, "Lr", "Lawrencium", new[]{262.10963}, new[]{100.0}, 262.10963,
				...
				new ChemElement(105, "Db", "Dubnium", new[]{268.12545}, new[]{100.0}, 268.12545,
					ChemElementType.TransitionMetal, null, "53850-35-4"),
				new ChemElement(106, "Sg", "Seaborgium", new[]{271.13347}, new[]{100.0}, 271.13347,
					ChemElementType.TransitionMetal, null, "54038-81-2"),
				new ChemElement(107, "Bh", "Bohrium", new[]{272.13803}, new[]{100.0}, 272.13803,
					ChemElementType.TransitionMetal, null, "54037-14-8"),
				new ChemElement(108, "Hs", "Hassium", new[]{270.13465}, new[]{100.0}, 270.13465,
					ChemElementType.TransitionMetal, null, "54037-57-9"),
				new ChemElement(109, "Mt", "Meitnerium", new[]{276.15116}, new[]{100.0}, 276.15116,
				...
				new ChemElement(111, "Rg", "Roentgenium", new[]{280.16447}, new[]{100.0}, 280.16447,
					ChemElementType.TransitionMetal, null, "54386-24-2"),
				new ChemElement(112, "Cn", "Copernicium", new[]{285.17411}, new[]{100.0}, 285.17411,
		...
		public static void DecodeComposition(string composition, Dictionary<string, ChemElement> elements1,
			out int[] counts, out string[] comp, out double[] monoMasses){
