...
namespace BaseLibS.Graph.Scroll{
	public class CompoundScrollableControlModel : BasicControlModel, ICompoundScrollableControl{
		...
		public CompoundScrollableControlModel(IGenericControl parent, ICompoundScrollableControlModel model){
			Client = model;
			Parent = parent;
			CreateModel();
			Parent.onResize = () => {
		...
		public int VisibleHeight =>
			Height1 - ColumnHeaderHeight - ColumnFooterHeight - (GraphUtil.scrollBarWidth);
