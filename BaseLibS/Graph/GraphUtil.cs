...
namespace BaseLibS.Graph{
	public static class GraphUtil{
		public static readonly bool newParameterPanel = true;
		...
		public static void PaintMoveUpButton(IGraphics g, Brush2 b, int x, int y, int bsize){
			...
			g.FillClosedCurve(Brushes2.White,
				new[]{
					new Point2(x + bsize / 2, y + 4), new Point2(x + 5, y + bsize - 4),
					new Point2(x + bsize - 5, y + bsize - 4)
				});
		}
		...
		public static void PaintMoveDownButton(IGraphics g, Brush2 b, int x, int y, int bsize){
			...
			g.FillClosedCurve(Brushes2.White,
				new[]{
					new Point2(x + bsize / 2, y + bsize - 4), new Point2(x + 5, y + 4), new Point2(x + bsize - 5, y + 4)
				});
		}
		...
		public static void PaintMoveLeftButton(IGraphics g, Brush2 b, int x, int y, int bsize){
			...
			g.FillClosedCurve(Brushes2.White,
				new[]{
					new Point2(x + 4, y + bsize / 2), new Point2(x + bsize - 4, y + 5),
					new Point2(x + bsize - 4, y + bsize - 5)
				});
		}
		...
		public static void PaintMoveRightButton(IGraphics g, Brush2 b, int x, int y, int bsize){
			...
			g.FillClosedCurve(Brushes2.White,
				new[]{
					new Point2(x + bsize - 4, y + bsize / 2), new Point2(x + 4, y + 5), new Point2(x + 4, y + bsize - 5)
				});
		}
		...
		public static void MQPaintOverview(IGraphics g, SizeI2 totalSize, RectangleI2 visibleWin,
		...
		public static bool MQHitsAZoomButton(int x, int y, int width, int height, double? f) =>
			GetNewZoomButtonState(x, y, width, height, true, f) == ZoomButtonState.Neutral;
