...
{
    public partial class LinearTransform : Form
    {

        public double minvalueclick = 0;
        public double maxvalueclick = 0;
        public LinearTransform(string title, double minValue, double maxValue)
        {
            InitializeComponent();
        ...
        {
            minvalueclick = minvalueclick - (minvalueclick / 10);
            minValueTextBox.Text = minvalueclick.ToString();
        }

        private void minusMaxValue_OnClick(object sender, EventArgs e)
        {
            maxvalueclick = maxvalueclick - (maxvalueclick / 10);
            maxValueTextBox.Text = maxvalueclick.ToString();
        }
