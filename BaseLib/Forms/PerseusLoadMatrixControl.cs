...
namespace BaseLib.Forms{
	public partial class PerseusLoadMatrixControl : UserControl{
		...
		public void UpdateFile(string filename){
			...
			try{
				colNames = TabSep.GetColumnNames(filename, StringUtils.commentPrefix, StringUtils.commentPrefixExceptions,
			...
			if (colTypes != null){
				FormUtil.SelectExact(colNames, colTypes, multiListSelectorControl1);
			} else{
				FormUtil.SelectHeuristic(colNames, multiListSelectorControl1);
			}
		}
