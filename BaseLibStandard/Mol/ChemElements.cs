	...
	public static class ChemElements {
		...
		private static ChemElement[] InitElements() {
			ChemElement[] e = {
				...
				new ChemElement(8, "O", "Oxygen", new[] {15.9949146221, 16.9991315, 17.9991604}, new[] {99.757, 0.038, 0.205},
					15.9994, ChemElementType.Nonmetal, new[] {-2}, "", false, 100),
				...
				new ChemElement(9, "F", "Fluorine", new[] {18.99840320}, new[] {100.0}, 18.9984032, ChemElementType.Halogen,
					new[] {-1}),
				new ChemElement(10, "Ne", "Neon", new[] {19.9924401754, 20.99384668, 21.991385114}, new[] {90.48, 0.27, 9.25},
					20.1797, ChemElementType.NobleGas, new[] {0}),
				...
				new ChemElement(50, "Sn", "Tin",
					new[] {
						...
						123.9052739
					}, new[] {0.97, 0.66, 0.34, 14.54, 7.68, 24.22, 8.59, 32.58, 4.63, 5.79}, 118.710, ChemElementType.BasicMetal,
					new[] {2, 4}),
				...
				new ChemElement(86, "Rn", "Radon", new[] {222.0175777}, new[] {100.0}, 222.0175777, ChemElementType.NobleGas,
					new[] {0}),
				...
				new ChemElement(103, "Lr", "Lawrencium", new[] {262.10963}, new[] {100.0}, 262.10963, ChemElementType.Actinide,
					null, "22537-19-5"),
