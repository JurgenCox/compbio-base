...
namespace PluginRawMzMl
{
    ...
    public class MzGrid : IReadOnlyCollection<double>
	{
        ...
        public void SmoothIntensities(double[] massesIn, double[] intensitiesIn,
            out double[] massesOut, out double[] intensitiesOut)
        {
            ...
            intensitiesOut = new double[gridIndexMax - gridIndexMin + 3];
            ...
            for (int i = 0; i < massesIn.Length; i++)
            {
                ...
                for (int ind = lind; ind <= uind; ind++)
                {
                    ...
                    intensitiesOut[curIndex] += intens;
